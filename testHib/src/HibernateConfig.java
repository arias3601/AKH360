...

{
    ...
    public HibernateConfig() {
        ...
        //THIS NEEDS TO BE 10 OR IT WONT WORK
        config.setProperty("hibernate.connection.pool_size", "10");

        config.setProperty("hibernate.connection.autocommit", "true");

        //THIS IS NEEDED TO USE THE NEW VERSION OF HIBERNATE
...
*/
        ...
        /*Hibernate 3.x - 4.2*/ //ServiceRegistry serviceRegistry = new StandardServiceRegistryBuilder().applySettings(config.getProperties()).build();
